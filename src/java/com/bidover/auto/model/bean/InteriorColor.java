...
public class InteriorColor implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InteriorColor)) {
            return false;
        }
        InteriorColor other = (InteriorColor) object;
    ...
    public String toString() {
        return "bidoverdb.bean.newpackage.InteriorColor[id=" + id + "]";
    }

    public String toXMLString() {
        StringBuilder xml = new StringBuilder(100);
        xml.append("<interior-color>");
        xml.append("<id>");
        xml.append(this.id);
        xml.append("</id>");
        xml.append("<title>");
