function createPreview(){
    ...
    if(!errorFlag){
        ...
        var contour = getSelectedOptionChild("contour-select");
        var diameter = getSelectedOptionChild("diameter-select");
        var season = getSelectedOptionChild("season-select");
        var make = getSelectedOptionChild("make-select");
        var previewDiv = document.getElementById("preview");
        var table = document.createElement("table");
        inserTr(table,"Width",document.createTextNode(width));
        inserTr(table,"Contour",document.createTextNode(contour));
        inserTr(table,"Item",document.createTextNode(diameter));
        inserTr(table,"Season",document.createTextNode(season));
        inserTr(table,"Make",document.createTextNode(make));
