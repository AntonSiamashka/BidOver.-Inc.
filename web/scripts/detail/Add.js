...
function showPreviewButton(){
    ...
    if(itemSelect.hasChildNodes()){
        if(item!="" && item!=null && model!=null&& model!=""){
            showElement("preview-button");
             getSalesDetails();
        }
    }else{
        if(subcategory!="" && subcategory!=null && model!=null && model!=""){
            showElement("preview-button");
            getSalesDetails();
        }
    }
