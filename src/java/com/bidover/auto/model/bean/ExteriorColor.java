...
public class ExteriorColor implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ExteriorColor)) {
            return false;
        }
        ExteriorColor other = (ExteriorColor) object;
    ...
    public String toString() {
        return "bidoverdb.bean.newpackage.ExteriorColor[id=" + id + "]";
    }

    public String toXMLString() {
        StringBuilder xml = new StringBuilder(100);
        xml.append("<exterior-color>");
        xml.append("<id>");
        xml.append(this.id);
        xml.append("</id>");
        xml.append("<title>");
