...
<html>
    <head>
        ...
        <script src="scripts/tires/validateAddWheels.js" type="text/javascript" ></script>
        <script src="scripts/tires/PreviewWheels.js" type="text/javascript" ></script>
    ...
    <body onload="getSalesDetails()">
        ...
        <br><br>
        <center>
            <form action="TiresController?command=ADDING_WHEELS" method="post">
                <div id="add-fields">
                    Ширина
                ...
                <div id="preview" style="visibility:hidden;display:none">
                    ...
                    <input id="add-button" type="submit" value="Add" name="add" OnClick="return validateAddWheels()"/>
                </div>
