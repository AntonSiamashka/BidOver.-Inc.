...
package com.bidover.tires.controller.servlet;
...
import com.bidover.tires.controller.factory.CommandFactory;
...
@Override
    public void destroy() {
        super.destroy();
        ConnectionPool сonnectionPool = ConnectionPool.getConnectionPool();
        сonnectionPool.closeAll();
    }
